...
if (!is_dir($dbDirectory)) {
    if (!mkdir($dbDirectory, 0777, true)) { // Ensure the directory is created recursively
        die('Failed to create directory ' . $dbDirectory);
    }
}

define('db_file', $dbDirectory . '/cashier_queuing_db.db');
